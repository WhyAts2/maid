...
module.exports = {
  info: {
    name: "volume",
    description: "Sunucu şarkı kuyruğu ses düzeyini değiştirmek için",
    usage: "[volume]",
    aliases: ["v", "vol"],
  },
  ...
  run: async function (client, message, args) {
    ...
    .setAuthor("Sunucu Ses Yöneticisi", "https://raw.githubusercontent.com/SudhanPlayz/Discord-MusicBot/master/assets/Music.gif")
    .setColor("BLUE")
